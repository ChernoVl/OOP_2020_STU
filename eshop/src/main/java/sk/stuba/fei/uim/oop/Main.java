...
import sk.stuba.fei.uim.oop.eshop.user.service.LoginPasswordUserService;
...
public class Main {
    ...
    public static void main(String[] args) {
        LoginPasswordUserService loginPasswordUserService = new LoginPasswordUserService();
        BasicItemService basicItemService = new BasicItemService("Katalóg");

        EShop eShop = new EShop(loginPasswordUserService, loginPasswordUserService, basicItemService, basicItemService, basicItemService);
        ...
        User user = eShop.getUserService().register("name", "surname", "surname@stuba.sk", "password");
        System.out.println(user);

        if (eShop.getAuthorisationService().logIn("surname@stuba.sk", "password")) {
